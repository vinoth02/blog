                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="email">Title:</label>
                        ...
                        <input type="hidden" name="id" class="form-control" id="id" value="{{ $post->id}}" placeholder="Enter Title">
                </div>
                <div class="form-group">
                    <label for="pwd">Post:</label>
                        <textarea name="post" id="" cols="60" rows="4" class="form-control" > {{ $post->post}}</textarea>
